...
const STATUS_CONFIG = {
  available: { label: "Available", color: "#4CAF7D", border: "rgba(76,175,125,0.25)" },
  beta:      { label: "Beta",      color: "#C8A84B", border: "rgba(200,168,75,0.25)" },
  "in-development": { label: "Coming Soon", color: "#4A5A6A", border: "rgba(74,90,106,0.25)" },
};
    ...
    <div style={{ background: "#141B27", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "120px 40px 100px" }}>
        ...
        <div style={{ marginBottom: 72 }}>
          ...
          >
            From general-purpose humanoid robots to precision end-effectors, we provide full-stack intelligent robotics solutions covering research and development, manufacturing, deployment, and operations.
          </p>
        </div>
